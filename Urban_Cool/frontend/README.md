...
- `components/ui/MapView.tsx` — MapLibre map: AOI-locked viewport with a visible boundary,
  drag-to-draw, and the data-driven metric/simulation circle layer.
- `components/ui/MetricTogglePanel.tsx`, `Legend.tsx` — the 8 real metric layers.
